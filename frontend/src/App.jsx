...
import ServoSection from './pages/ServoSection.jsx'
...
import EditSections from './pages/admin/EditSections.jsx'
          ...
          <div className="contentwrapper">
            ...
            <div className="content">
              <Routes>
                ...
                {/* Legacy routes redirect to dynamic section pages */}
                <Route path="/dome" element={<Navigate to="/section/dome" replace />} />
                <Route path="/body" element={<Navigate to="/section/body" replace />} />
                <Route path="/section/:sectionId" element={<ServoSection />} />
                ...
                <Route path="/admin/sections" element={<EditSections />} />
